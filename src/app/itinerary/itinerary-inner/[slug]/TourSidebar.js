export default function TourSidebar({ pax, days }) {
  return (
    <div className="bg-white shadow-lg rounded-2xl p-6 sticky top-32">
      ...
      <button className="mt-6 w-full py-3 bg-[#1e3a5f] hover:bg-[#162f4b] text-white font-semibold rounded-xl transition">
        Book This Tour
      </button>
    </div>
  );
